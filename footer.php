...
<?php
$footer_settings = getSettingPageField('footer');
$social_settings = getSettingPageField('social');

$footer_bg = $footer_settings['background_image'] ?? [];
$footer_bg_image_id = $footer_bg['id'] ?? 0;

?>
<footer class="px-3 py-4 position-relative">
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="icons">
                        ...
                        echo get_template_part(
                            ...
                            null,
                            array(
                                'icons' => $social_settings['social_networks'] ?? [],
                            )
                        );
                        ?>
                    </div>
                </div>
                <?= display_custom_footer_menu(); ?>
                <div class="col-md-3 col-12">
                    <div class="parent-menu contact-us">
                        צור קשר
                    </div>
                    <?php
                    echo get_template_part(
...
<a href="https://api.whatsapp.com/message/M4ZVKGMLGH5JI1" class="whatsapp-float" target="_blank">
